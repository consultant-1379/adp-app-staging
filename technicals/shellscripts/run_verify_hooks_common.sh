...
\\n Example: adp-app-staging/technicals/shellscripts/run_verify_hooks_common.sh <GERRIT_PATCHSET_REVISION> <BUILD_URL> <BASE_DIR> [WORKSPACE] [technicals/hooks/pre_*]
