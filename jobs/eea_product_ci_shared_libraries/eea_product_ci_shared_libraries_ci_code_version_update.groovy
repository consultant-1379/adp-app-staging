pipelineJob('eea-product-ci-shared-libraries-ci-code-version-update') {
            ...
            scm{
                git {
                    remote {
                        ...
                        scriptPath('pipelines/eea_product_ci_shared_libraries/eea_product_ci_shared_libraries_ci_code_version_update.Jenkinsfile')
                    }
                    branch('${MAIN_BRANCH}')
                }
            }
