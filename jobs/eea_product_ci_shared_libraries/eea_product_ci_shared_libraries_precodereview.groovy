pipelineJob('eea-product-ci-shared-libraries-precodereview') {
            ...
            scm {
                git {
                    remote {
                        ...
                        scriptPath('pipelines/eea_product_ci_shared_libraries/eea_product_ci_shared_libraries_precodereview.Jenkinsfile')
                    }
                    branch('${MAIN_BRANCH}')
                }
            }
