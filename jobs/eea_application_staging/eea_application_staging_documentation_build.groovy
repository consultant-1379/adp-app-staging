pipelineJob('eea-application-staging-documentation-build') {
            ...
            scm{
                git {
                    remote {
                        ...
                        scriptPath('pipelines/eea_application_staging/eea_application_staging_documentation_build.Jenkinsfile')
                    }
                    branch('${MAIN_BRANCH}')
                }
            }
