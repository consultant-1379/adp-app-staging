pipelineJob('eea-product-ci-meta-baseline-loop-test') {
            ...
            scm{
                git {
                    remote {
                        ...
                        scriptPath('pipelines/eea_product_ci_meta_baseline_loop/eea_product_ci_meta_baseline_loop_test.Jenkinsfile')
                    }
                    branch('${MAIN_BRANCH}')
                }
            }
