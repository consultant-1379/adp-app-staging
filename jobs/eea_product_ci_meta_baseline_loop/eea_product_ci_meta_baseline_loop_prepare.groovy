pipelineJob('eea-product-ci-meta-baseline-loop-prepare') {
            ...
            scm{
                git {
                    remote {
                        ...
                        scriptPath('pipelines/eea_product_ci_meta_baseline_loop/eea_product_ci_meta_baseline_loop_prepare.Jenkinsfile')
                    }
                    branch('${MAIN_BRANCH}')
                }
            }
