pipelineJob('eea-app-baseline-manual-flow-verify-cr') {
            ...
            scm{
                git {
                    remote {
                        ...
                        scriptPath('pipelines/eea_app_baseline_manual_flow/eea_app_baseline_manual_flow_verify_cr.Jenkinsfile')
                    }
                    branch('${MAIN_BRANCH}')
                }
            }
