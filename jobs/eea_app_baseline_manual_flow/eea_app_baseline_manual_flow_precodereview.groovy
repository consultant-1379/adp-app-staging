pipelineJob('eea-app-baseline-manual-flow-precodereview') {
            ...
            scm{
                git {
                    remote {
                        ...
                        scriptPath('pipelines/eea_app_baseline_manual_flow/eea_app_baseline_manual_flow_precodereview.Jenkinsfile')
                    }
                    branch('${MAIN_BRANCH}')
                }
            }
