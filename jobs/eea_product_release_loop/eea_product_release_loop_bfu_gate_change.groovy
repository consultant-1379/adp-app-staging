pipelineJob('eea-product-release-loop-bfu-gate-change') {
            ...
            scm{
                git {
                    remote {
                        ...
                        scriptPath('pipelines/eea_product_release_loop/eea_product_release_loop_bfu_gate_change.Jenkinsfile')
                    }
                    branch('${MAIN_BRANCH}')
                }
            }
